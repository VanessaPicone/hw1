<?php 
    ...
    ********************************************************/
    ...
    $next = isset($_GET['from']) ? 'AND postes.id < '.mysqli_real_escape_string($conn, $_GET['from']).' ' : '';
        ...
        $query = "SELECT id, user_id, photo, name, rating, address, description from postes where user_id = $userid ORDER BY id DESC LIMIT 10";
