      ...
      <nav class="menu">
        ...
        <div id="link4-view" class="modal hidden">
          ...
          <div class="buttons">
            ...
            <div id="button2" data-modal="modal-view-Accedi"><a>Accedi</a></div>
<!-- Accesso-->
            <div id="modal-view-Accedi" class="modal1 hidden">
              <div class="modal-content" data-content="modal-content">
                <div id="X-Accedi"><i class="fa-solid fa-x"></i></div>
                <div id="p1">
                  <img src="https://static.tacdn.com/img2/brand_refresh/Tripadvisor_logoset_solid_green.svg">
                  <p>Accedi per scoprire il meglio di Tripadvisor.</p>
                  <div class="accessi">
                    <?php
                        if (isset($error)) {
                            echo "<p class='error'>";
